...
struct Home: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 15) {
            ...
            .frame(minWidth: nil, alignment: .leading)
            .padding()
            ...
            // Snap Caroucel
            SnapCaroucel(index: $currentIndex, items: posts) { post in
        ...
        .frame(minWidth: nil, alignment: .top)
        .onAppear {
            for index in 1...5 {
                posts.append(Post(postImage: "Movie\(index+1)"))
            }
        }
    }
}
